...
class MessageInfo :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_rpcserver_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
// string service_name = 1;
inline void MessageInfo::clear_service_name() {
  service_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& MessageInfo::service_name() const {
  // @@protoc_insertion_point(field_get:MessageInfo.service_name)
  return _internal_service_name();
}
inline void MessageInfo::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:MessageInfo.service_name)
}
inline std::string* MessageInfo::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:MessageInfo.service_name)
  return _internal_mutable_service_name();
}
inline const std::string& MessageInfo::_internal_service_name() const {
  return service_name_.GetNoArena();
}
inline void MessageInfo::_internal_set_service_name(const std::string& value) {
  
  service_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void MessageInfo::set_service_name(std::string&& value) {
  
  service_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:MessageInfo.service_name)
}
inline void MessageInfo::set_service_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  service_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:MessageInfo.service_name)
}
inline void MessageInfo::set_service_name(const char* value, size_t size) {
  
  service_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:MessageInfo.service_name)
}
inline std::string* MessageInfo::_internal_mutable_service_name() {
  
  return service_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* MessageInfo::release_service_name() {
  // @@protoc_insertion_point(field_release:MessageInfo.service_name)
  
  return service_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void MessageInfo::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MessageInfo.service_name)
}

// string method_name = 2;
inline void MessageInfo::clear_method_name() {
  method_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& MessageInfo::method_name() const {
  // @@protoc_insertion_point(field_get:MessageInfo.method_name)
  return _internal_method_name();
}
inline void MessageInfo::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:MessageInfo.method_name)
}
inline std::string* MessageInfo::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:MessageInfo.method_name)
  return _internal_mutable_method_name();
}
inline const std::string& MessageInfo::_internal_method_name() const {
  return method_name_.GetNoArena();
}
inline void MessageInfo::_internal_set_method_name(const std::string& value) {
  
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void MessageInfo::set_method_name(std::string&& value) {
  
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:MessageInfo.method_name)
}
inline void MessageInfo::set_method_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:MessageInfo.method_name)
}
inline void MessageInfo::set_method_name(const char* value, size_t size) {
  
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:MessageInfo.method_name)
}
inline std::string* MessageInfo::_internal_mutable_method_name() {
  
  return method_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* MessageInfo::release_method_name() {
  // @@protoc_insertion_point(field_release:MessageInfo.method_name)
  
  return method_name_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void MessageInfo::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MessageInfo.method_name)
}
