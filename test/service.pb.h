...
class LoginResponse :
 ...
 public:
  ...
  const std::string& isloginsuccess() const;
  void set_isloginsuccess(const std::string& value);
  void set_isloginsuccess(std::string&& value);
  void set_isloginsuccess(const char* value);
  void set_isloginsuccess(const char* value, size_t size);
  std::string* mutable_isloginsuccess();
  std::string* release_isloginsuccess();
  void set_allocated_isloginsuccess(std::string* isloginsuccess);
  private:
  const std::string& _internal_isloginsuccess() const;
  void _internal_set_isloginsuccess(const std::string& value);
  std::string* _internal_mutable_isloginsuccess();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr isloginsuccess_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_service_2eproto;
};
// -------------------------------------------------------------------
...
class RegResponse :
 ...
 public:
  ...
  const std::string& isregsuccess() const;
  void set_isregsuccess(const std::string& value);
  void set_isregsuccess(std::string&& value);
  void set_isregsuccess(const char* value);
  void set_isregsuccess(const char* value, size_t size);
  std::string* mutable_isregsuccess();
  std::string* release_isregsuccess();
  void set_allocated_isregsuccess(std::string* isregsuccess);
  private:
  const std::string& _internal_isregsuccess() const;
  void _internal_set_isregsuccess(const std::string& value);
  std::string* _internal_mutable_isregsuccess();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr isregsuccess_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_service_2eproto;
};
// ===================================================================
...
inline void LoginResponse::clear_isloginsuccess() {
  isloginsuccess_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& LoginResponse::isloginsuccess() const {
  // @@protoc_insertion_point(field_get:LoginResponse.isLoginSuccess)
  return _internal_isloginsuccess();
}
inline void LoginResponse::set_isloginsuccess(const std::string& value) {
  _internal_set_isloginsuccess(value);
  // @@protoc_insertion_point(field_set:LoginResponse.isLoginSuccess)
}
inline std::string* LoginResponse::mutable_isloginsuccess() {
  // @@protoc_insertion_point(field_mutable:LoginResponse.isLoginSuccess)
  return _internal_mutable_isloginsuccess();
}
inline const std::string& LoginResponse::_internal_isloginsuccess() const {
  return isloginsuccess_.GetNoArena();
}
inline void LoginResponse::_internal_set_isloginsuccess(const std::string& value) {
  
  isloginsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void LoginResponse::set_isloginsuccess(std::string&& value) {
  
  isloginsuccess_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:LoginResponse.isLoginSuccess)
}
inline void LoginResponse::set_isloginsuccess(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  isloginsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:LoginResponse.isLoginSuccess)
}
inline void LoginResponse::set_isloginsuccess(const char* value, size_t size) {
  
  isloginsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:LoginResponse.isLoginSuccess)
}
inline std::string* LoginResponse::_internal_mutable_isloginsuccess() {
  
  return isloginsuccess_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LoginResponse::release_isloginsuccess() {
  // @@protoc_insertion_point(field_release:LoginResponse.isLoginSuccess)
  
  return isloginsuccess_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LoginResponse::set_allocated_isloginsuccess(std::string* isloginsuccess) {
  if (isloginsuccess != nullptr) {
    
  } else {
    
  }
  isloginsuccess_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), isloginsuccess);
  // @@protoc_insertion_point(field_set_allocated:LoginResponse.isLoginSuccess)
}
...
inline void RegResponse::clear_isregsuccess() {
  isregsuccess_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RegResponse::isregsuccess() const {
  // @@protoc_insertion_point(field_get:RegResponse.isRegSuccess)
  return _internal_isregsuccess();
}
inline void RegResponse::set_isregsuccess(const std::string& value) {
  _internal_set_isregsuccess(value);
  // @@protoc_insertion_point(field_set:RegResponse.isRegSuccess)
}
inline std::string* RegResponse::mutable_isregsuccess() {
  // @@protoc_insertion_point(field_mutable:RegResponse.isRegSuccess)
  return _internal_mutable_isregsuccess();
}
inline const std::string& RegResponse::_internal_isregsuccess() const {
  return isregsuccess_.GetNoArena();
}
inline void RegResponse::_internal_set_isregsuccess(const std::string& value) {
  
  isregsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RegResponse::set_isregsuccess(std::string&& value) {
  
  isregsuccess_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RegResponse.isRegSuccess)
}
inline void RegResponse::set_isregsuccess(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  isregsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:RegResponse.isRegSuccess)
}
inline void RegResponse::set_isregsuccess(const char* value, size_t size) {
  
  isregsuccess_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:RegResponse.isRegSuccess)
}
inline std::string* RegResponse::_internal_mutable_isregsuccess() {
  
  return isregsuccess_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RegResponse::release_isregsuccess() {
  // @@protoc_insertion_point(field_release:RegResponse.isRegSuccess)
  
  return isregsuccess_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RegResponse::set_allocated_isregsuccess(std::string* isregsuccess) {
  if (isregsuccess != nullptr) {
    
  } else {
    
  }
  isregsuccess_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), isregsuccess);
  // @@protoc_insertion_point(field_set_allocated:RegResponse.isRegSuccess)
}
